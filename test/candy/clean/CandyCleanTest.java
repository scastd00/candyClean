...
public class CandyCleanTest {
    ...
    public void testHaveWon() throws CandyCleanException {
        ...
        predefinedBoard.shoot(2, 4);
        predefinedBoard.shoot(3, 3);
        predefinedBoard.shoot(3, 3);
        predefinedBoard.shoot(4, 3);
        predefinedBoard.shoot(4, 0);
	    predefinedBoard.shoot(4, 0);
	    predefinedBoard.shoot(4, 0);
    ...
    public void testDebugBoard(){
        assertEquals("RRRRR BBRRR BBBBB GGBBB BBGGG ", predefinedBoard.debugBoard());
    }
